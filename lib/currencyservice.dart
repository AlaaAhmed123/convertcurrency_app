...
import 'package:currencyapp/dashboard.dart';
...
class CurrencyService {
  ...
  convertCurrency(int check, String fromCurrency, String toCurrency, int amount,
      context) async {
    ...
    Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (context) =>
            DashboardPage(
                ...
                (1/(amount * body["rates"][toCurrency])).toStringAsFixed(5),
                convertedCurrency: check == 0 ?  (amount *
                    body["rates"][toCurrency]).toStringAsFixed(4) : amount,
