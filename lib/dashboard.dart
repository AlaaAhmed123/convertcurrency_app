...
import 'package:currencyapp/currency_list.dart';
import 'package:currencyapp/currencyservice.dart';
import 'package:currencyapp/red_input.dart';
import 'package:currencyapp/white_input.dart';
            ...
            child: Center(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: () {
                    Navigator.of(context).push(CupertinoPageRoute(
                        builder: (context) => CurrencyList(widget.currencyone,widget.currencytwo,1)));
                  },
                  child: Text(
